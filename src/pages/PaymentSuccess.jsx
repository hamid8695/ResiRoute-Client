    ...
    return (
      ...
      <div>
        <div class="flex flex-col items-center space-y-2">
          ...
          <h1 class="text-4xl font-bold">Payment Recieved!</h1>
          <p>Your transaction was successful! Your transaction id is: {id} </p>
          <a
            ...
            <span class="text-sm font-medium cursor-pointer" onClick={() => navigate(`/`)}>
              Home
            </span>
          </a>
        </div>
