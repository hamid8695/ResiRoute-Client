...
const SignUp = () => {
    ...
    const onSubmit = async (data) => {
        ...
        console.log('helloooooooooooo',data)
    ...
    return (
                ...
                <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    ...
                    <div class="w-full flex justify-center">
                        ...
                        <p>Already have an account?
                                <Link to='/login' className="label-text-alt link text-sm link-hover">Login Here
                                </Link>
                            </p>
                    </div>
        ...
        //             <figure className='w-1/2'><img className='w-full' src={signupImg} alt="login" /></figure>
        ...
        //                         <button
        //                         type='submit' 
        //                         className="btn btn-primary text-white">Sign Up</button>
        //                     </div>
        //                     <label className="label">
        //                         <p>Already have an account?
        //                             <Link to='/login' className="label-text-alt link text-sm link-hover"> Login Here
